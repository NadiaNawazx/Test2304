...
public class AmazonInc {
    ...
    public static void main(String[] args) {
        ...
        ProductOwner po = new ProductOwner("Manha", 4, 'F', 1, 160000, company);

        BusinessAnalyst ba = new BusinessAnalyst("Sadia", 44, 'F', 2, 150000, company);

        ScrumMaster sm = new ScrumMaster("Nazia", 46, 'F', 3, 140000, company);
