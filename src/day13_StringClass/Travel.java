...
public class Travel {
    public static void main(String[] args) {
        ...
        if (yesOrNo.equals("yes")) {
            ...
            System.out.println("How many bags will you be taking?");
            ...
            System.out.println("Your ticket is booked to " + country + ". We have charged extra for the " + numberOfBags + " bags but you are traveling with " + numberPeople + " passengers so we are giving a discount. Your total cost is £" + cost + ".");
